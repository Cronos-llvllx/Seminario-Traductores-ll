        ...
        if(cadena[i]=='<') {
            ...
            if(cadena[i]=='"') {
                ...
                if(cadena[i]==';') {
                    i--;
                    if(cadena[i]=='"') {
                        cout<<"La cadena es correcta. IMPRESION DE PANTALLA."<<endl;
                    } else {
                        cout<<"Error de sintaxis"<<endl;
                    }
                } else {
        ...
        if(cadena[i]=='>') {
            ...
            if(cadena[x]==';') {
                ...
                if(es_identificador(reserva)) {
                    cout<<"La cadena es correcta. ENTRADA DE DATOS."<<endl;
                } else {
                    cout<<"Error de sintaxis"<<endl;
                }
            } else {
...
void sintactico_prototipo(string cadena) {
    ...
    cout<<"La cadena es correcta. DECLARACION DE PROTOTIPO DE FUNCION."<<endl;
    return;
}

void sintactico_funciones(string cadena) {
    cout<<"La cadena es correcta. FUNCION."<<endl;
    return;
}
    ...
    if(hay_llave) { // si esta
        ...
        if(es_identificador(ide)) { // (tipo de dato) (identificador) ;
            ...
            if(!existe_variable(ide)){
                ...
                cout <<"\t<ERROR: REDECLARACION DE VARIABLE>"<<endl;
            }
